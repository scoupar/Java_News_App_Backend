...
public class DataLoader implements ApplicationRunner {
    ...
    public void run (ApplicationArguments args) {
        ...
        Article article2 = new Article("Prince Philip: Scotland hails 'a remarkable man'", "Tributes have been paid in Scotland to the Duke of Edinburgh following his death aged 99.", "Tributes have been paid in Scotland to the Duke of Edinburgh following his death at the age of 99.\n" +
                ...
                "\n" +
                "First Minister Nicola Sturgeon said Prince Philip, who became the Duke of Edinburgh in 1947, had \"deep and longstanding\" ties to Scotland.", LocalDate.of(2021, 3, 10), tina, Category.News, "https://ichef.bbci.co.uk/news/976/cpsprodpb/15C7A/production/_117901298_gettyimages-598902202-1.jpg");
        ...
        Article article5 = new Article("Fishing boat sank due to engine room flooding", "A report has found flooding in the engine room caused a Scots trawler to sink.", "A fishing boat sank off the Scottish coast because of engine room flooding, a report has said.\n" +
                ...
                "\n" +
                "The alarm was raised in good time and the subsequent rescue ensured everyone was safely transferred ashore.\"", LocalDate.of(2021, 04, 20), gregor, Category.News, "https://ichef.bbci.co.uk/news/976/cpsprodpb/B660/production/_117888664_oceanquestmaib.jpg");
        ...
        Article article7 = new Article("DMX, American rapper and actor, dies aged 50", "US rapper DMX has died five days after suffering a heart attack.", "US rapper and actor DMX has died at the age of 50, five days after suffering a heart attack.\n" +
                ...
                "\n" +
                "Earl's music inspired countless fans across the world and his iconic legacy will live on forever,\" they said.", LocalDate.of(2021, 04, 8), tina, Category.Entertainment, "https://ichef.bbci.co.uk/news/976/cpsprodpb/16C0/production/_117942850_gettyimages-1173545968.jpg");
        ...
        Article article8 = new Article("Nikki Grahame's friends 'heartbroken' at Big Brother star's death", "Friends of Big Brother star Nikki Grahame have spoken of their heartbreak following her death.", "Friends of Big Brother star Nikki Grahame have spoken of their heartbreak following her death, aged 38.\n" +
                ...
                "\n" +
                "She said: \"Life on the other side of an eating disorder, there's just so much positivity and so much potential.\"", LocalDate.of(2021, 04, 11), tina, Category.Entertainment, "https://ichef.bbci.co.uk/news/976/cpsprodpb/1817D/production/_117958689_nggettyimages-157813565.jpg");
        ...
        Article article9 = new Article("MotoGP: Maverick Vinales wins season opener in Qatar", "Spaniard Maverick Vinales won the MotoGP season opener", "Spaniard Maverick Vinales won the opening race of the MotoGP season in Qatar.\n" +
                ...
                "\n" +
                "He finished in a time of 40 minutes 3.123 seconds, with Australian Remy Gardner second and Italian Fabio di Giannantonio third.", LocalDate.of(2021, 04, 4), scott, Category.Sports, "https://ichef.bbci.co.uk/onesport/cps/800/cpsprodpb/C480/production/_117740305_gettyimages-1231989493.jpg");
        ...
        Article article12 = new Article("Scottish election 2021: Lib Dems pledge tax cut to help high street firms", "Liberal Democrats reveal plan to \"shake up\" business rates system.", "The Scottish Liberal Democrats plan to \"shake up\" the business rates system in a bid to help high street shops compete with online competitors.\n" +
                ...
                "\n" +
                "The party says this will avoid penalising businesses that improve their properties, install renewables or make their customers safer with coronavirus mitigation measures.", LocalDate.of(2021, 04, 2), helen, Category.Politics, "https://ichef.bbci.co.uk/news/976/cpsprodpb/93CE/production/_117883873_highstreet_inverness_getty.jpg");
        articleRepository.save(article12);

        Article article13 = new Article("Covid in Scotland: Hospitality calls for faster reopening", "Hospitality and tourism leaders have criticised the Covid restrictions which prevent the sectors' reopening.", "They were speaking as England's lockdown rules eased further, with pub gardens and restaurants among the places able to reopen.\n" +
                "\n" +
                ...
                "\n" +
                "Be responsible, says PM as rules ease across UK\n" +
                "\n" +
                ...
                "\n" +
                "It is currently against the law to travel across the border except for essential reasons.\n" +
                "\n" +
                ...
                "\n.", LocalDate.of(2021, 02, 21), gregor, Category.News, "https://ichef.bbci.co.uk/news/976/cpsprodpb/9717/production/_117997683_gettyimages-1214930170.jpg");
        articleRepository.save(article13);

        Article article14 = new Article("The Friends reunion has been filmed in Los Angeles: Here's what we know", "It's almost 17 years since pop culture's six most-famous friends were together on a film set, but The One With The Reunion was finally shot last week.", "The special one-off show brought together the sitcom's original cast of Matthew Perry (Chandler), Jennifer Aniston (Rachel), Courteney Cox (Monica), Lisa Kudrow (Phoebe), Matt LeBlanc (Joey) and David Schwimmer (Ross).\n" +
                "\n" +
                ...
                "\n" +
                "A broadcast date is yet to be announced but it's expected to be over the next few months.", LocalDate.of(2021, 03, 1), helen, Category.Entertainment, "https://ichef.bbci.co.uk/news/976/cpsprodpb/17908/production/_118002569_gettyimages-77701720.jpg");
